...
*/
	/* GENERAL */
	$general = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$us_general_params);
	...
	// Sessions (visits) over/under 60 seconds
		...
		// raw numbers
		$us_sessions_under_60_seconds = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$us_sessions_under_60_seconds_params);
		$us_sessions_greater_equal_60_seconds = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$us_sessions_greater_equal_60_seconds_params);
			// percentage
	...
	*/ 
		...
		$us_traffic_source_vice = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$souce_vice_params);
		...
		$us_traffic_source_mobo = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$source_mobo_params);
		...
		$us_traffic_source_noisey = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$source_noisey_params);
		...
		$us_traffic_source_news = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$source_news_params);
		...
		$us_traffic_source_thump = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$source_thump_params);
		...
		$us_traffic_source_fightland = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$source_fightland_params);
		...
		$us_traffic_source_tcp = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$source_tcp_params);
		...
		$us_traffic_source_iD = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$source_iD_params);
		...
		$us_traffic_source_sports = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$source_sports_params);
		...
		$us_traffic_source_munchies = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$source_munchies_params);
		...
		*/
			...
			// Facebook
			$us_traffic_source_facebook = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$source_facebook_params);
			// twitter
			$us_traffic_source_twitter = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$source_twitter_params);
			// reddit 
			$us_traffic_source_reddit = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$source_reddit_params);
			// youtube
			$us_traffic_source_youtube = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$source_youtube_params);
		...
		$us_traffic_source_search = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$source_search_params);
		...
		$us_traffic_source_direct = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$source_direct_params);
		...
		$us_mobile_tablet = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$mobile_tablet_params);
