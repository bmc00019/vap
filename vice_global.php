...
// General
$vice_global_general = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics);
...
$vice_global_mobile_tablet = $service->data_ga->
	get($noisey_id,$start_date,$end_date,$mobile_metrics,$mobile_opt_params);
...
$vice_global_general_users = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$new_vs_returning);
...
// Sessions/Visits for Return Users who have visited the site 26 times or more
	...
	$vice_global_user_count = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$user_session_count_params);
...
// Sessions/Visits over and under 60 seconds
	...
	$vice_global_session_duration = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$user_session_duration_params);
	...
	$vice_global_session_duration = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$user_session_duration_params_2);
...
$referral = 'gaid::-8';
	...
	$vg_direct_traffic_data = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$direct_params);
	...
	$vg_paid_traffic_data = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$paid_params);
	...
	$vg_search_traffic_data = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$search_params);
	...
	$vg_facebook_traffic_data = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$facebook_params);
	...
	$noisey_traffic_source_data = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$noisey_sources_params);
	...
	$motherboard_traffic_source_data = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$motherboard_sources_params);
	...
	$fightland_traffic_source_data = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$fightland_sources_params);
	...
	$thecreatorsproject_traffic_source_data = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$thecreatorsproject_sources_params);
	...
	$thump_traffic_source_data = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$thump_sources_params);
	...
	$social_traffic_source_data = $service->data_ga->get($noisey_id,$start_date,$end_date,$general_metrics,$ft_sources_params);
